...
app.get("/posts/:test",function(req,res){
  ...
  //var autocorrectBody=lodash.lowerCase(title);
  var autocorrectURL =lodash.lowerCase(params);
  var f=false;
  posts.forEach(function(post){
    if(lodash.lowerCase(post.title)===autocorrectURL){
      res.render("post",{titleURL : post.title , contentURL : post.content})
    }
  })
  if(f){
